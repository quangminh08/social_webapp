			...
			<div style="text-decoration: none; border: 1px solid green; max-width: 135px;">
 				<c:choose>
					<c:when test="${isInGroup == true}">
						<a href="${classpath }/user/group/leave/${groupFocus.id }" role="button" style="text-decoration: none; color: black; text-align: center">Rời nhóm</a>
					</c:when>
					<c:otherwise>
						<a href="${classpath }/user/group/join/${groupFocus.id }" role="button" style="text-decoration: none; color: black; text-align: center">Tham gia nhóm</a>
					</c:otherwise>
				</c:choose>
